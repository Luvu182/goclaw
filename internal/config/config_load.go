...
func (c *Config) applyEnvOverrides() {
	...
	// Default provider/model: env is fallback (only when config file has no value).
	// This lets onboard set initial values via env, but Dashboard saves take precedence.
